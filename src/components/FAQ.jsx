  ...
  render() {
    ...
    return (
      <div className="bg-off-black white ma0 pa3 measure">
        ...
        <Question focusedDetail={focusedDetail} handleChange={this.handleChange} index={1}
        ...
        <Question focusedDetail={focusedDetail} handleChange={this.handleChange} index={2}
        ...
        <Question focusedDetail={focusedDetail} handleChange={this.handleChange} index={3}
        ...
        <Question focusedDetail={focusedDetail} handleChange={this.handleChange} index={4}
