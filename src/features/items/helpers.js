...
export const getGemQualities = (_contract, _tokenId) =>
  _contract.getProperties(_tokenId, (error, _properties) => {
    if (!error) {
    ...
    console.log("get gem qualities error", error);
  });

export const getPrice = (_tokenId, _contract) =>
  _contract.getCurrentPrice(Number(_tokenId));
...
export const removeAuctionHelper = (dutchContract, tokenId) =>
