...
export const acquiredOutlineColor = "#EF6E7E";
export const acquiredPaneColor = "#700E23";
export const restingEnergyOutlineColor = "#79D7B9";
export const restingEnergyPaneColor = "#204F3E";
